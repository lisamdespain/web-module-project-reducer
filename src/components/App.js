...
import { applyNumber, changeOperation, clearDisplay, storeToMemory, memoryToTotal, memoryClear } from '../actions/index'
import './App.css';
...
const handleStoreToMemory = () =>{
  dispatch(storeToMemory());
}
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={handleStoreToMemory}/>
